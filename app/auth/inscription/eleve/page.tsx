...
export default function InscriptionElevePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/auth/inscription/eleve", {
        method: "POST",
        ...
        <Card variant="elevated">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Créez votre compte pour suivre vos notes et présences
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Input
                label="Code élève"
                value={formData.codeEleve}
                onChange={(e) =>
                  setFormData({ ...formData, codeEleve: e.target.value })
                }
                required
